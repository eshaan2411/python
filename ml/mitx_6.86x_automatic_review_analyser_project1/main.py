...
avg_peg_train_accuracy, avg_peg_test_accuracy = \
   p1.classifier_accuracy(p1.pegasos, train_bow_features, test_bow_features, train_labels, \
       test_labels, T=T_peg, L=L_peg)
print("{:50} {:.4f}".format("Training accuracy for Pegasos:", avg_peg_train_accuracy))
print("{:50} {:.4f}".format("Testing for Pegasos:", avg_peg_test_accuracy))
...
best_theta = p1.pegasos(train_bow_features, train_labels, T = T_peg, L = L_peg)[0]
